...
urlpatterns = [
    ...
    url(r'^account/loggedin/quit_group/$', views.quit_group, name='quit_group'),
    url(r'^account/loggedin/(\d+)/$', views.member_edit_group, name='member_edit_group'),
    url(r'^account/loggedin/grant_access_to_files/$', views.grant_access_to_files, name='grant_access_to_files'),
    url(r'^account/loggedin/grant_access_to_files_failed/$', views.grant_access_to_files_failed,
        name='grant_access_to_files_failed'),
    ...
    url(r'^account/folders/(\d+)/$', views.edit_folder, name='edit_folder'),
    url(r'^account/folders/(\d+)/add_folder/$', views.add_subfolder),
    url(r'^account/folders/(\d+)/change_parent/$', views.change_parent),
    url(r'^account/folders/(\d+)/rename/$', views.rename_folder),
    url(r'^account/folders/(\d+)/copy_folder/$', views.copy_folder),
    url(r'^account/folders/(\d+)/remove/$', views.remove_folder),
    url(r'^account/reports/(\d+)/$', views.edit_report),
    url(r'^account/reports/(\d+)/change_group/$', views.report_change_group),
    url(r'^account/reports/(\d+)/change_folder/$', views.report_change_folder),
    url(r'^account/reports/(\d+)/rename/$', views.rename_report),
    url(r'^account/reports/(\d+)/copy/$', views.copy_report),
    url(r'^account/reports/(\d+)/remove/$', views.remove_report),
